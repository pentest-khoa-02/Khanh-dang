...
```
await keyword :  là keyword đứng trước các promise , nó được sử dụng trong hàm async , nó sẽ bắt hàm async đợi đến khi promise trả về value , nếu có lỗi thì kết hợp thêm try/catch để bắt lỗi thì await 
## Arrow Function
